...
${OBJECTDIR}/BaseMenu.o: BaseMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseMenu.o BaseMenu.cpp
...
${OBJECTDIR}/CourseMenu.o: CourseMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CourseMenu.o CourseMenu.cpp
...
${OBJECTDIR}/ProfessorMenu.o: ProfessorMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProfessorMenu.o ProfessorMenu.cpp
...
${OBJECTDIR}/StudentMenu.o: StudentMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StudentMenu.o StudentMenu.cpp
...
${OBJECTDIR}/BaseMenu_nomain.o: ${OBJECTDIR}/BaseMenu.o BaseMenu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseMenu_nomain.o BaseMenu.cpp;\
	else  \
...
${OBJECTDIR}/Course_nomain.o: ${OBJECTDIR}/Course.o Course.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Course_nomain.o Course.cpp;\
	else  \
...
${OBJECTDIR}/CourseMenu_nomain.o: ${OBJECTDIR}/CourseMenu.o CourseMenu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CourseMenu_nomain.o CourseMenu.cpp;\
	else  \
...
${OBJECTDIR}/MainMenu_nomain.o: ${OBJECTDIR}/MainMenu.o MainMenu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MainMenu_nomain.o MainMenu.cpp;\
	else  \
...
${OBJECTDIR}/Person_nomain.o: ${OBJECTDIR}/Person.o Person.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Person_nomain.o Person.cpp;\
	else  \
...
${OBJECTDIR}/Professor_nomain.o: ${OBJECTDIR}/Professor.o Professor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Professor_nomain.o Professor.cpp;\
	else  \
...
${OBJECTDIR}/ProfessorMenu_nomain.o: ${OBJECTDIR}/ProfessorMenu.o ProfessorMenu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProfessorMenu_nomain.o ProfessorMenu.cpp;\
	else  \
...
${OBJECTDIR}/Secretary_nomain.o: ${OBJECTDIR}/Secretary.o Secretary.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Secretary_nomain.o Secretary.cpp;\
	else  \
...
${OBJECTDIR}/StudentMenu_nomain.o: ${OBJECTDIR}/StudentMenu.o StudentMenu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StudentMenu_nomain.o StudentMenu.cpp;\
	else  \
