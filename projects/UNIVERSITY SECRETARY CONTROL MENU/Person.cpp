...
Person::Person(string name, unsigned int communicationSkills, unsigned int curiosity) :
    name(name), communicationSkills(communicationSkills), curiosity(curiosity) {
    }
